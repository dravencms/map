...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $operations = [
            'map' => [
                'edit' => 'Umožnuje editaci map',
                'delete' => 'Umožnuje smazání map'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\Map\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}